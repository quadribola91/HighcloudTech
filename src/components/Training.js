      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-white p-6 rounded-lg shadow-md shadow-blue-200 hover:shadow-blue-300 transition-transform transform hover:scale-105 hover:shadow-xl duration-300">
            ...
            <p>
              Our program covers web development, team management, project management, and more. You'll gain hands-on experience and valuable knowledge that can set you apart in the industry.
            </p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-md shadow-blue-200 hover:shadow-blue-300 transition-transform transform hover:scale-105 hover:shadow-xl duration-300">
